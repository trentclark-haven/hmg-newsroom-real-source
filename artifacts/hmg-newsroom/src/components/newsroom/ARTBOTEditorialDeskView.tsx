...
export function ARTBOTEditorialDeskView() {
  ...
  function runAnalysis() {
    if (!topic.trim()) {
      toast.error("Add a topic or headline to get started.");
      return;
    }
    setRunning(true);
    setTimeout(() => {
    ...
    <div className="flex-1 flex flex-col overflow-y-auto px-4 lg:px-8 py-5 gap-5">
      ...
      <div className="flex flex-col gap-1">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-black tracking-tight">Editorial Analysis</h1>
      ...
      <div className="rounded-xl border border-sky-500/30 bg-sky-500/[0.06] px-4 py-3 flex items-start gap-3">
        ...
        <p className="text-[12px] text-sky-200/80 leading-relaxed">
          <strong className="text-sky-300">This desk does not browse, generate, or claim facts.</strong> All outputs are deterministic suggestions based on your inputs and local memory. Use it to think faster — you verify, write, and publish.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-border/60 bg-card/50 p-4 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <Textarea
            ...
            placeholder="Paste your draft or rough notes here — the desk will check it for gossip language, source flags, and excerpt quality."
            rows={5}
      ...
      {results && (
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-black uppercase tracking-[0.2em] text-sky-400 px-2">Analysis Results</span>
            <div className="h-px flex-1 bg-border/40" />
          </div>
      ...
      <div className="text-center text-[11px] text-muted-foreground/50 py-2">
        Editorial Analysis · Local-only · No fake providers · HMG Newsroom
      </div>
    </div>
  );
}
