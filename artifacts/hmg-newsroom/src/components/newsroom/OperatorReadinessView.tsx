        ...
        <div className="flex flex-col gap-3">
          ...
          {[
            ...
            },
            {
              ...
              lane: "Article writing, headline variants, SEO prep, WordPress draft prep. Runs Editorial Desk and Editorial Analysis.",
              ...
              localNote: "Editorial Analysis and WordPress draft builder both work in local mode. No fake publish.",
            },
            {
