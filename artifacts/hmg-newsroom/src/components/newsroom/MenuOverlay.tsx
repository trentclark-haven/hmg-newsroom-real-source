...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    id: "recovery",
    label: "System Health",
    description: "Check that everything is running and backed up",
    icon: HeartPulse,
    color: "#22C55E",
  },
  {
    ...
    description: "Your inbox, task queue, and next moves",
  ...
  },
  {
    id: "seomaster",
    label: "SEO Master",
    description: "Headlines, meta descriptions, and search checklist",
    icon: Search,
    color: "#10B981",
  },
  {
    id: "artbot",
    label: "WebArt",
    description: "Create brand graphics, images, and visual assets",
    icon: Brush,
    color: "#A855F7",
  },
  {
    id: "cutmaster",
    label: "WebEdit",
    description: "Plan edits, write cut notes, and prep video",
    icon: Video,
    color: "#EF4444",
  },
  {
    id: "clipbrand",
    label: "Clip + Brand",
    description: "Package video with titles, captions, and thumbnails",
    icon: Film,
    color: "#6366F1",
  },
  {
  ...
  },
  {
    id: "corpus",
    label: "HMG Memory",
    description: "Brand rules, saved facts, and research notes",
    icon: Database,
    color: "#14B8A6",
  },
  {
    ...
    description: "See what writing intelligence is connected and ready",
    icon: Brain,
    color: "#7C3AED",
  },
  {
    id: "aistaff",
    label: "AI Staff",
    description: "Staff writing prompts and Founder Voice settings",
    icon: Users,
    color: "#FBBF24",
  },
  {
    ...
    description: "Saved articles, social posts, and WordPress drafts",
    icon: ImageIcon,
    color: "#22D3EE",
  },
  {
  ...
  },
  {
    id: "auditlog",
    label: "Receipt Log",
    description: "Every action taken, with sensitive details hidden",
    icon: ScrollText,
    color: "#94A3B8",
  },
  {
  ...
  },
  {
    ...
    description: "Load HMG DNA — Founder Voice, brand rules, and notes",
    icon: BookMarked,
    color: "#6366F1",
  },
  {
    ...
    description: "All saved WordPress drafts — copy, export, or send to Social",
    icon: FileText,
    color: "#F59E0B",
  },
  {
    ...
    description: "What writing intelligence is active and what needs setup",
    icon: Brain,
    color: "#8B5CF6",
  },
  {
    ...
    description: "Headline variants, source check, and SEO prep",
    icon: Newspaper,
    color: "#38BDF8",
  },
  {
    ...
    description: "Team roster, task assignments, and connection status",
    icon: Users,
    color: "#0EA5E9",
  },
  {
    ...
    description: "Check if WordPress and other services are reachable",
    icon: Activity,
    color: "#0EA5E9",
  },
  {
    ...
    description: "Check app install, offline access, and App Store path",
    icon: Smartphone,
    color: "#06B6D4",
  },
  {
    id: "sessionrecap",
    label: "Session Recap",
    description: "Today's work, memory state, and recommended next steps",
    icon: ScrollText,
    color: "#6366F1",
  },
];
...
export const MENU_SECTIONS: { label: string; hint: string; ids: View[] }[] = [
  {
    label: "Ship Now",
    hint: "Editorial, social, WordPress, outputs",
    ids: [
      "newsroom",
      "socialfactory",
      "wp-draft-history",
  ...
  {
    label: "Create Assets",
    hint: "WebArt, video, SEO, clips, scheduling",
    ids: [
      "artbot",
      "cutmaster",
      "clipbrand",
  ...
  {
    label: "Intelligence",
    hint: "Memory, brand DNA, AI guidance",
    ids: [
      "corpus",
      "founderkb",
      "havenai",
  ...
  {
    label: "Operations",
    hint: "Command, team, connections, health",
    ids: [
      "commandcenter",
      "assignments",
      "sales",
