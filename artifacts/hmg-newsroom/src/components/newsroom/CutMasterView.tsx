...
import { OfficialSourceGuide } from "./OfficialSourceGuide";
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap gap-1 mt-1.5">
            <TruthChip label="Local Timeline Mode" status="local" />
            <TruthChip label="Memory-Backed" status="local" />
            <TruthChip label="Transcription Hook Pending" status="pending" />
            <TruthChip label="Render Backend Pending" status="pending" />
          </div>
          <p className="text-[10px] text-muted-foreground mt-1 leading-snug">
            Haven AI can prepare your edit plan locally. Real transcription and rendering require the future media backend.
          </p>
        </div>
      </div>
        ...
        {step6Open && (
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground mt-1">Preview frame only — real crop requires editor or render backend.</p>
            </div>
            ...
            <div className="rounded-xl border border-amber-500/20 bg-amber-500/[0.05] px-3 py-2 text-[11px] text-amber-300/80">
              ...
              <strong>Render Backend Pending.</strong> Crop notes are saved locally. Real format delivery requires the future media backend.
            </div>
          </div>
        )}
      </section>
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-xl border border-border/60 bg-secondary/20 p-3 space-y-2">
            ...
            <p className="text-[10px] text-muted-foreground leading-snug">
              Copy the clip package below and paste it into Social Factory › From WebEdit. Direct handoff is planned for a future backend pass.
            </p>
