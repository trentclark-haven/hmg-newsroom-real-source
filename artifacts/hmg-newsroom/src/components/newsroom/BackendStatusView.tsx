...
const ROUTES: RouteSpec[] = [
  ...
  },
  {
    ...
    description: "Returns known WordPress site connections. Currently returns empty list — no live WP sync.",
    relatedView: "wpconnections",
    honestNote: "Returns 200 but with empty sites array. Configure WP REST credentials to activate.",
  },
  {
  ...
  },
  {
    ...
    description: "AI content generation endpoint. Contract defined — server implementation needed.",
    relatedView: "aicapability",
    honestNote: "Returns 501 — the contract is defined in OpenAPI but no AI provider is connected.",
  },
  {
    path: "/api/generate-image",
    method: "POST",
    label: "Image Generation",
    description: "AI image generation endpoint. Contract defined — backend provider needed.",
    relatedView: "artbot",
    honestNote: "Returns 501 — image model provider not connected. Backend proxy required.",
  },
  {
    ...
    relatedView: "wpconnections",
    honestNote: "Returns 501 — no live publish. Manual copy/paste to WordPress is the current path.",
  },
  {
