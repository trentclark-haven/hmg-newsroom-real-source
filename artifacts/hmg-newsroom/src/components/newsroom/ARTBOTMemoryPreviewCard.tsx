    ...
    >
      ...
      {lastUpdated && (
        <div className="px-4 pb-1 text-[10px] text-muted-foreground">
          Last editorial memory update: {lastUpdated}
        </div>
      )}
      ...
      <div className="px-4 py-3 mx-4 mb-4 rounded-xl border" style={{ borderColor: `${ARTBOT_COLOR}30`, background: `${ARTBOT_COLOR}0D` }}>
        ...
        <p className="text-[10px] text-muted-foreground mt-1">
          Deterministic — no external AI connection — no fake providers
        </p>
      </div>
      ...
      <div className="px-4 pb-3 flex items-center gap-1.5">
        ...
        <p className="text-[10px] text-muted-foreground">
          Editorial = content analysis assistant. Not graphics. Not WebArt.
        </p>
      </div>
    </div>
  );
